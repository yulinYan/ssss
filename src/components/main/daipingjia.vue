<template>
    <div class="f-daipingjia-con">
        <div class="f-daipingjia-order" v-if="AllorderInfo.order == 0">
            <img src="assets/images/mine/search_result_none.png"/>
            <p>您还没有待评价订单</p>
            <p>可以去逛逛有没有想买的</p>
        </div>
        <div v-else class="f-daipingjia-info">
