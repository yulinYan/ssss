<template>
    <div class="f-daifukuan-con">
        <div class="f-daifukuan-order" v-if="AllorderInfo.order == 0">
            <img src="assets/images/mine/search_result_none.png"/>
            <p>您还没有待付款订单</p>
            <p>可以去逛逛有没有想买的</p>
        </div>
        <div v-else class="f-daifukuan-info">
